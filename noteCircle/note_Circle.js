...
function draw() {
    ...
    text("- ~> clockwise step     ", width/2+10, -height/2+f*t++);
    text("_ ~>  ^x7               ", width/2+10, -height/2+f*t++);
    text("= ~> anticlockwise step ", width/2+10, -height/2+f*t++);
    text("+ ~>  ^x7               ", width/2+10, -height/2+f*t++);
    ...
    text("s ~> toggle intervals   ", width/2+10, -height/2+f*t++);
                                                             t++;
