...
noteCircle.addEventListener("load", function(){
    ...
    _0 = noteCircleDOM.getElementById("major");           _0.style.transformOrigin = "-19% 18%";  _0.style.transition = " transform 500ms";
    _1 = noteCircleDOM.getElementById("melodicMinor");    _1.style.transformOrigin = "-19% 18%";  _1.style.transition = " transform 500ms";
    _2 = noteCircleDOM.getElementById("harmonicMinor");   _2.style.transformOrigin = "-19% 18%";  _2.style.transition = " transform 500ms";
    _3 = noteCircleDOM.getElementById("harmonicMajor");   _3.style.transformOrigin = "-19% 18%";  _3.style.transition = " transform 500ms";
    _4 = noteCircleDOM.getElementById("doubleHarmonic");  _4.style.transformOrigin = "-19% 18%";  _4.style.transition = " transform 500ms";
